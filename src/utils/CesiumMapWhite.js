/*
 * @Author: zhangxi
 * @Date: 2020-02-20 14:25:06
 * @Last Modified by: zhangxi
 * @Last Modified time: 2020-02-21 12:41:20
 */
...
class CesiumUtils {
  ...
  init (id) {
    ...
    // 自定义地图底图
    this.viewer.imageryLayers.addImageryProvider(new Cesium.SingleTileImageryProvider({url: './static/CesiumAssets/images/gray7.png'}))
  ...
  setStyle () {
    ...
    this.scene.skyAtmosphere.hueShift = -0.04
    this.scene.skyAtmosphere.saturationShift = 0.55
    this.scene.skyAtmosphere.brightnessShift = -0.32
    this.scene.fog.enabled = true
    this.scene.fog.density = 0.0001
    this.scene.fog.screenSpaceErrorFactor = 1
    // 添加环境光源
    // this.scene.lightSource.ambientLightColor = Cesium.Color.fromCssColorString('rgba(11,53,104,0.4)')
    this.setAllLight()
    // 天空盒子
  ...
  setAllLight () {
    ...
    var targetPosition1 = new Cesium.Cartesian3(-1562891.6259222326, 5323685.281797321, 3117344.1876635756)
    // var targetPosition2 = new Cesium.Cartesian3(-1596935.6259222326, 5323685.281797321, 3117344.1876635756)
    var targetPosition3 = new Cesium.Cartesian3(-1596935.6259222326, 5315685.281797321, 3141668.320506441)
    var options1 = {
      // color: Cesium.Color.fromCssColorString('rgba(111,120,137,0.1)'), // 光源颜色
      color: Cesium.Color.fromCssColorString('rgb(255,233,209,1)'), //
      targetPosition: targetPosition1,
      intensity: 0.9
    }
    var options2 = {
      color: Cesium.Color.fromCssColorString('rgba(222,222,222,1)'), //
      intensity: 0.25
    }
    var options3 = {
      color: Cesium.Color.fromCssColorString('rgba(0,46,123,1)'), //
      intensity: 0.9,
    ...
    var directionalLightH3 = new Cesium.DirectionalLight(position1, options3)
    this.scene.addLightSource(directionalLightH1)
    this.scene.addLightSource(directionalLightH2)
    this.scene.addLightSource(directionalLightH3)
  }
  setLayers (layer, type) {
    var Cesium = this.Cesium
    var hypsometricSetting = new Cesium.HypsometricSetting()
    var colorTable = new Cesium.ColorTable()
    colorTable.insert(150, Cesium.Color.fromCssColorString('rgba(130,130,130,1)'))
    colorTable.insert(68, Cesium.Color.fromCssColorString('rgba(130,130,130,1)'))
    colorTable.insert(55, Cesium.Color.fromCssColorString('rgba(130,130,130,1)'))
    colorTable.insert(45, Cesium.Color.fromCssColorString('rgba(130,130,130,1)'))
    colorTable.insert(10, Cesium.Color.fromCssColorString('rgba(130,130,130,1)'))
    colorTable.insert(2, Cesium.Color.fromCssColorString('rgba(130,130,130,1)'))
    ...
    if (type === '01') { // 纹理图片存在
      hypsometricSetting.emissionTextureUrl = './static/CesiumAssets/images/gao13.png'
      hypsometricSetting.emissionTexCoordScale = new Cesium.Cartesian2(0.12, 0.1)
      hypsometricSetting.Opacity = 1
    } else if (type === '02') {
      hypsometricSetting.emissionTextureUrl = './static/CesiumAssets/images/gao13.png'
