 ...
 * @LastEditors: zhangxi
 * @LastEditTime: 2020-05-22 10:25:55
 -->
<template>
  <div>
      <div class="makers-box">
        ...
        <div class="g-detail-box2" v-if="detailFlag">
            ...
            <div class="g-detail-list">
                ...
                <div class="g-context-box">
                    <ul class="g-content-ul" v-for="(item03,index03) in listDataItem.detailsList" :key="index03">
                        <li :title="item03.level">{{item03.level}}</li>
                        <li :title="item03.name">{{item03.name}}</li>
                        <li :title="item03.address">{{item03.address || ' '}} </li>
                        <li><div class="g-detail-go" @click.stop="goTo3dDetail(item03)"></div></li>
                    </ul>
                </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    goSearch () {
      let ite = {}
      ite.value = this.listDataItem.typeList[this.activeSelect].value
    ...
    showDetail (item) {
      ...
      //   console.log(err)
      // })
      API.POINTSDETAIL(this, { id: item.id })
        .then(resV => {
