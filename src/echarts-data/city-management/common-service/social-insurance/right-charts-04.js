 ...
 * @LastEditTime: 2020-04-28 14:11:47
 */
...
function setData (data) {
  ...
  data.yearTypeNumList.forEach((item, index) => {
    ...
    xAxisData.push(str)
    try {
      item.peopleNumList.forEach((nItem, newIndex) => {
  ...
  console.log('legend', legendData, seriesArr, data)
    ...
    yAxis: [
      {
        name: '(万人次)',
        nameTextStyle: {
          // padding: [0, 0, 2 * window.$rem, -18 * window.$rem],
