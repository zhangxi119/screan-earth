 ...
 * @LastEditors: zhangxi
 * @LastEditTime: 2020-05-07 19:51:41
 */
...
var context = {
  ...
  init: function (data) {
    var that = this
    if (data) {
      CONSTANTS.result.responsibleBodyInfo = data
    }
    // 排序（大到小）
...
function ListItem (data, i) {
  ...
  this.view.bottom.append(this.view.percent = $(' <div class="body-item-percent" style="color: #ABEEF5;width: 0.8rem;">1.6<span style="color: #4D8FE6;"> 万</span></div>'))
...
ListItem.prototype = {
  ...
  updateView: function () {
    ...
    this.view.percent.append(this.percent + `<span style="color: #4D8FE6;"> 人</span>`)
  }
}
/* 责任主体配置，渲染JS结束 */
